...
class ProjectCard extends Component {
  ...
  renderProject() {
    const projectCard = this.createElement(
      "div",
      ["project-card"],
      "projectCard"
    );
...
class NavCard extends Component {
  ...
  renderModal() {
    const modalElement = this.createElement(
      "dialog",
    ...
    modalElement
      ...
      .addEventListener("click", () => {
        const newProject = new ProjectCard(
          ...
          modalElement.querySelector("#description").value,
          modalElement.querySelector("#priority").value
        );
